...
echo "Command: bundlecraft fetch --source-config-file config/cert_sources/mozilla.yaml --dry-run --json"
echo ""
...
echo ""
SUCCESS=$(bundlecraft fetch --source-config-file config/cert_sources/mozilla.yaml --dry-run --json | jq -r '.success')
...
echo ""
OUTPUT=$(bundlecraft fetch --source-config-file config/cert_sources/mozilla.yaml --dry-run --json)
