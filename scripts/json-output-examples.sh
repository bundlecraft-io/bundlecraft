...
echo "Command: bundlecraft fetch --bundle-config-file config/bundles/mozilla.yaml --dry-run --json"
echo ""
bundlecraft fetch --bundle-config-file config/bundles/mozilla.yaml --dry-run --json | jq .
echo ""
...
echo ""
SUCCESS=$(bundlecraft fetch --bundle-config-file config/bundles/mozilla.yaml --dry-run --json | jq -r '.success')
...
echo ""
OUTPUT=$(bundlecraft fetch --bundle-config-file config/bundles/mozilla.yaml --dry-run --json)
