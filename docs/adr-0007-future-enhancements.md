...
2. **Maintenance cost:** Can it be maintained by solo dev?
3. **Security benefit:** Does it meaningfully improve security posture?
4. **Complexity ratio:** Is the value worth the added complexity?
5. **Alternative solutions:** Can existing features solve the problem?
...
2. Prototype in a feature branch
3. Assess maintenance burden
4. Document implementation in dedicated ADR if complex
