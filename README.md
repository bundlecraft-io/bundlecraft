...
- **Dependency lock file:** Production builds use exact dependency versions from `requirements-lock.txt` for reproducibility (see [`docs/DEPENDENCY-LOCK.md`](./docs/DEPENDENCY-LOCK.md))
