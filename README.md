...
| `scripts/test-server-local.py` | Local HTTPS server with `/test-cert.pem`, `/Certificates/Download`, and `/apidocs` (used in CI) | `./scripts/test-server-local.py up --port 8443 --token mock-token-12345` |
